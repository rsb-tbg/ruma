...
pub type AppserviceToDeviceForwardedRoomKeyEvent =
    AppserviceToDeviceEvent<ToDeviceForwardedRoomKeyEventContent>;
pub type AppserviceToDeviceForwardedRoomKeyEventContent = ToDeviceForwardedRoomKeyEventContent;
...
// /// The content of an `m.forwarded_room_key` appservice event.
// ///
// /// To create an instance of this type, first create a `ToDeviceForwardedRoomKeyEventContentInit`
// /// and convert it via `AppserviceToDeviceForwardedRoomKeyEventContent::from` / `.into()`.
// #[derive(Clone, Debug, Deserialize, Serialize, EventContent)]
// #[cfg_attr(not(ruma_unstable_exhaustive_types), non_exhaustive)]
// #[ruma_event(type = "m.forwarded_room_key", kind = AppserviceToDevice)]
// pub struct AppserviceToDeviceForwardedRoomKeyEventContent {
//     /// The encryption algorithm the key in this event is to be used with.
//     pub algorithm: EventEncryptionAlgorithm,
...
// impl From<ToDeviceForwardedRoomKeyEventContentInit>
//     for AppserviceToDeviceForwardedRoomKeyEventContent
// {
//     fn from(init: ToDeviceForwardedRoomKeyEventContentInit) -> Self {
//         Self {
//             algorithm: init.algorithm,

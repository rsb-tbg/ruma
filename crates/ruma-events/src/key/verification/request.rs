...
pub type AppserviceToDeviceKeyVerificationRequestEvent =
    AppserviceToDeviceEvent<ToDeviceKeyVerificationRequestEventContent>;
pub type AppserviceToDeviceKeyVerificationRequestEventContent =
...
// /// The content of an `m.key.verification.request` appservice event.
// #[derive(Clone, Debug, Deserialize, Serialize, EventContent)]
// #[cfg_attr(not(ruma_unstable_exhaustive_types), non_exhaustive)]
// #[ruma_event(type = "m.key.verification.request", kind = AppserviceToDevice)]
// pub struct AppserviceToDeviceKeyVerificationRequestEventContent {
//     /// The device ID which is initiating the request.
//     pub from_device: OwnedDeviceId,
...
// impl AppserviceToDeviceKeyVerificationRequestEventContent {
//     /// Creates a new `AppserviceToDeviceKeyVerificationRequestEventContent` with the given
// device     /// ID, transaction ID, methods and timestamp.
//     pub fn new(
//         from_device: OwnedDeviceId,
//         transaction_id: OwnedTransactionId,
//         methods: Vec<VerificationMethod>,

...
pub type AppserviceToDeviceDummyEvent = AppserviceToDeviceEvent<ToDeviceDummyEventContent>;
pub type AppserviceToDeviceDummyEventContent = ToDeviceDummyEventContent;
...
// #[derive(Clone, Debug, Default, EventContent)]
// #[allow(clippy::exhaustive_structs)]
// #[ruma_event(type = "m.dummy", kind = AppserviceToDevice)]
// pub struct AppserviceToDeviceDummyEventContent;

// impl AppserviceToDeviceDummyEventContent {
//     /// Create a new `AppserviceToDeviceDummyEventContent`.
//     pub fn new() -> Self {
//         Self
//     }
// }

// impl<'de> Deserialize<'de> for AppserviceToDeviceDummyEventContent {
//     fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
//     where
//         D: Deserializer<'de>,
//     {
...
//         impl<'de> de::Visitor<'de> for Visitor {
//             type Value = AppserviceToDeviceDummyEventContent;
...
//             {
//                 while map.next_entry::<de::IgnoredAny, de::IgnoredAny>()?.is_some() {}
//                 Ok(AppserviceToDeviceDummyEventContent)
//             }
//         }

//         deserializer.deserialize_struct("AppserviceToDeviceDummyEventContent", &[], Visitor)
//     }
// }

// impl Serialize for AppserviceToDeviceDummyEventContent {
//     fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
//     where
//         S: Serializer,
//     {
//         serializer.serialize_struct("AppserviceToDeviceDummyEventContent", 0)?.end()
//     }
// }
